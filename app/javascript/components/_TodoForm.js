...
import { Form, Button, Input, Dropdown, TextArea, Message } from "semantic-ui-react";
...
function _TodoForm(formikValues, handleSubmit, categories, error) {
	...
	// Insert uncategorized/all option at the top of the dropdown list.
				...
				<Form onSubmit={props.handleSubmit}>
					<Form.Field>
						...
						<Input
							...
							onChange={(e, { value }) => {
								props.setFieldValue("attributes.title", value);
								error = false;
							}}
						/>
						{error && (
					...
					<Form.Field>
						...
						<TextArea
							...
							onChange={(e, { value }) => props.setFieldValue("attributes.description", value)}
						/>
					</Form.Field>
					<Datepicker customInput={<CustomInput />} name="attributes.duedate" isClearable />
					<Form.Field>
						...
						<Dropdown
							...
							options={options}
							defaultValue={
								formikValues.attributes.categoryid == null
									? -1
									: formikValues.attributes.categoryid.toString()
							}
							onChange={(e, { value }) => props.setFieldValue("attributes.categoryid", value)}
						/>
					</Form.Field>
